...
|-----------|-------------|----------|
| **Asana Task Service** | FastAPI microservice for creating Asana tasks | `asana_task_service/` |
| **Documentation** | Setup guides and architecture docs | Root directory |
...
See `asana_task_service/README.md` for detailed deployment instructions.

## Environment Variables

Create a `.env` file in `asana_task_service/`:
